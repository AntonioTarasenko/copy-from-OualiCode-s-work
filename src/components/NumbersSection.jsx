  ...
  return (
    <section className='mx-auto w-full relative text-white mt-40 flex justify-center'>
      ...
      <motion.section
        ...
        className='relative z-1 mx-auto w-11/12 lg:mx-0 p-5 sm:p-6 py-6 sm:py-8 rounded-3xl border border-primary bg-[#ffffff29] shadow-lg *: md:divide-x divide-primary grid grid-cols-2 md:grid-cols-4 gap-4 dm:gap-6 lg:gap-12'
      >
        {Numbers.map((item) => (

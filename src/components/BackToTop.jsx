...
export default function BackToTop() {
  ...
  return (
    <>
    {showButton && (
        <button onClick={scrollToTop} className='fixed bottom-8 right-8 bg-transparent text-primary p-3 rounded-full shadow-lg transition-colors z-[150] flex items-center justify-center' aria-label='scroll to top' style={{width:'50px',height:'50px'}}>
